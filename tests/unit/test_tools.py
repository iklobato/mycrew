...
def test_make_pr_body_includes_task_and_issue():
    ...
    from code_pipeline.tools.create_pr_tool import _make_pr_body
    ...
    assert "_Generated by code_pipeline_" in body
...
@patch("code_pipeline.tools.github_api_search_tool.requests.get")
